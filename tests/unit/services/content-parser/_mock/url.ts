...
export const urlTagMocks: UrlTagMocks = {
  normal: [
    ...
    Passwörter werden natürlich nicht gespeichert. Weil der Quellcode offen ist, lässt sich das [url=https&#58;//github.com/potber/potber-client/blob/develop/app/controllers/login.ts#L30]hier[/url] (Client) und [url=https://github.com/potber/potber-api/blob/develop/src/auth/auth.service.ts#L19]hier[/url] (API) auch nachprüfen.`,
      expected: `[b][i]Du willst doch mein Passwort![/i][/b]
    Passwörter werden natürlich nicht gespeichert. Weil der Quellcode offen ist, lässt sich das <a href="https&#58;//github.com/potber/potber-client/blob/develop/app/controllers/login.ts#L30" target="_blank">hier</a> (Client) und <a href="https&#58;//github.com/potber/potber-api/blob/develop/src/auth/auth.service.ts#L19" target="_blank">hier</a> (API) auch nachprüfen.`,
    },
    {
