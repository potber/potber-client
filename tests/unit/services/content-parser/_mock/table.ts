export const tableTagMocks: ContentParserMock[] = [
  ...
  },
  {
    ...
    Ameisenfutter [||] JS & Web-Kram (<a href="https://github.com/potber" target="_blank">GitHub</a>)
    ...
    [/table]`,
    expected: `<table><tr><td>Ameisenfutter</td><td>JS & Web-Kram (<a href="https://github.com/potber" target="_blank">GitHub</a>)</td></tr><tr><td>anoX*</td><td>so ziemlich alles (und ABAP, lel)</td></tr><tr><td>Atomsk</td><td>TSQL, DAX, C#</td></tr></table>`,
  },
  {
