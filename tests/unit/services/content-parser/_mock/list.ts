export const listTagMocks: ContentParserMock[] = [
  ...
  },
  {
    input:
      ...
      '[*] <a href="https://github.com/potber/potber-api/blob/develop/README.md" target="_blank">Dokumentation</a>' +
      '[*] <a href="https://github.com/potber/potber-api/blob/develop/CHANGELOG.md" target="_blank">Changelog</a>' +
      '[*] <a href="https://github.com/potber/potber-api/issues" target="_blank">GitHub Issues</a> - Bugs & Feature requests' +
      '[*]<a href="https://github.com/potber/potber-api" target="_blank">GitHub Repository</a>' +
    ...
    expected:
      ...
      '<li><a href="https://github.com/potber/potber-api/blob/develop/README.md" target="_blank">Dokumentation</a></li>' +
      '<li><a href="https://github.com/potber/potber-api/blob/develop/CHANGELOG.md" target="_blank">Changelog</a></li>' +
      '<li><a href="https://github.com/potber/potber-api/issues" target="_blank">GitHub Issues</a> - Bugs & Feature requests</li>' +
      '<li><a href="https://github.com/potber/potber-api" target="_blank">GitHub Repository</a></li>' +
